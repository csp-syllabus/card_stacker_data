import { Ticker, Texture } from '@pixi/core';
...
class ScrollBox extends Container {
  ...
  addBackground() {
    this.background = typeof this.options.background === "string" ? new Sprite(Texture.from(this.options.background)) : new Graphics();
