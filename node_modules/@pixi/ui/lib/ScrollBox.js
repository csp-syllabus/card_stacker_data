...
var ScrollSpring = require('./utils/trackpad/ScrollSpring.js');
...
class ScrollBox extends display.Container {
  constructor(options) {
    ...
    const spring = new ScrollSpring.default();
  ...
  addBackground() {
    this.background = typeof this.options.background === "string" ? new sprite.Sprite(core.Texture.from(this.options.background)) : new graphics.Graphics();
  ...
  resize() {
    ...
    if (this.borderMask && (this.lastWidth !== this.layoutWidth || this.lastHeight !== this.layoutHeight)) {
      ...
      hitbox.removeHitBox(this.borderMask);
      if (this.background instanceof graphics.Graphics && typeof this.options.background === "number") {
