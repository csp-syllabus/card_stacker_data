...
class Slider extends display.Container {
  constructor(options) {
    super();
    this.dragging = 0;
    /** TODO */
    ...
    const slider = typeof options.slider === "string" ? new sprite.Sprite(core.Texture.from(options.slider)) : options.slider;
    slider.x = slider.width / 2;
    this.slider = new display.Container();
  ...
  makeScrollable() {
    ...
    hitbox.removeHitBox(this.fill, this.valueText);
  }
  onSetByClick(event) {
