...
<div id="slider-aps-${aps}"></div></div></div></li>`;
     ...
     //////////////////////////
        ...
        if (!instance.data.halt) {
            ...
            function buildHierarchyHtml(hierarchy) {
                instance.data.logging ? console.log("heirBuild", hierarchy):null;
                hierarchy = JSON.parse(hierarchy);
                instance.data.logging ? console.log('buildHierarchyHtml Declared'):null;
                let cardListHtml = '';
                for (i = 0; i < hierarchy.length; i++) {
                    ...
                    //instance.data.logging ? console.log(cardListHtml):null;     
                    let childCardHtml = '';
            ...
            function main() {
                ...
                if (!instance.data.hierarchyInitial) {
                    ...
                    let cardsListHtml = '';
                    for (i = 0; i < instance.data.APS.length; i++) {
    ...
    if (instance.data.html_field && !instance.data.hierarchyInitial) {
                        ...
                        for (i = 0; i < instance.data.allcards.length; i++) {
